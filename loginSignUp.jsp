                            ...
                            <div class="input-group">
                                ...
                                <div style="margin-top:10px" class="form-group">
                                    ...
                                    <div class="col-sm-12 controls">
                                      <a id="btn-login" href="#" class="btn btn-success" style="width: 150px">Login  </a>
                                    </div>

                                    <div class="col-sm-12 controls" style="margin-top:10px;">   
                                      <a id="btn-gmaillogin" href="#" class="btn btn-danger" style="width: 150px">Login with Gmail</a>
                                      <a id="btn-fblogin" href="#" class="btn btn-primary" style="width: 150px">Login with Facebook</a>
